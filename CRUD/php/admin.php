...
<form id="formdto" action="" name="dtoNuevo" method="post">
 ...
 <div class="col-12 col-m-4">
  ...
  <div class="col-12 col-m-4">
    <button id="nDto" class="btn btn-outline-dark m-1">Nuevo</button>
    <button id="updateDto" class="btn btn-outline-dark m-1">Actualizar</button>
  ...
  <div class="col-12 col-m-4">
   ...
   <div class="col-12 col-sm-6">
      <button id="admin"  class="btn btn-outline-dark m-1">activar solicitud</button>
      </div>
</div>
<?php
if(isset($_GET['okdto'])){
...
<div class="col-sm-12 col-md-6">
 ...
 <?php  
  ...
  <div class="col-12 col-m-4"> 
    ...
    <div class="col-12 col-sm-6">
      <button id="add"  class="btn btn btn-outline-dark m-1">Nuevo</button>
      <button id="update" class="btn btn btn-outline-dark m-1">Actualizar</button>
   </div>
      <div class="col-12 col-sm-6">
         <button id="" name="btnclear" class="btn btn btn-outline-dark m-1">Limpiar</button>
         <button id=""  name="listlastname"class="btn btn btn-outline-dark m-1">Apellidos</button>
         <button id="" name="query" class="btn btn btn-outline-dark m-1">Empleados</button>
      </div>
...
<div class="col-3">
     ...
     <div id="listado" class="col-4">
      ...
      $sqlqueryjoin ="SELECT empleados.dni,empleados.nombre,empleados.apellido,empleados.activo, departamentos.nombre_dto,departamentos.presupuesto FROM empleados,departamentos where empleados.num_dto = departamentos.id_dto ORDER BY (nombre_dto)";
        ...
        echo '<td><button id="eliminar"  class="btn btn-danger"><a href="deluser.php?dni='.$file['dni'].'">Eliminar</a></button>
        </td>';        
         echo'</tr>';
...
<div class="col-12">
   ...
   while ($fila = mysqli_fetch_array($result)){
      ...
      echo '<td><button id="eliminar"  class="btn btn-danger"><a href="deldto.php?id_dto='.$fila['id_dto'].'">Eliminar</a></button></td>';
...
<script type="text/javascript">
  let btnAddDto = document.getElementById("nDto");
btnAddDto.addEventListener('click', validarAdd);
...
let btnactivar = document.getElementById("admin");
btnactivar.addEventListener('click',admin);
